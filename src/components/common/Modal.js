...
import { XMarkIcon } from '@heroicons/react/24/outline'; // Ícono de cerrar

/**
 * Componente Modal genérico.
 *
 * Muestra contenido dentro de una ventana modal flotante.
 *
 ...
 * @returns {JSX.Element} El elemento JSX del modal.
 */
